  ...
  <div class="container py-5">
    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">Monitor and manage your Flink jobs</p>
      </div>
    ...
    <!-- Empty State -->
    <div v-else-if="jobs.length === 0" class="table-wrapper">
      <div class="empty-state">
        ...
        <p class="empty-state-description">Submit your first Flink job to get started</p>
        <router-link :to="{ name: 'AddJob' }" class="btn btn-primary">
          Submit Job
        </router-link>
      </div>
      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="job in jobs" :key="job.id">
            ...
            <td>
              <router-link :to="`/jobs/show/${job.id}`" class="table-action">
                View Details
...
const getStatusBadgeClass = (state) => {
  ...
  if (lowerState === 'running' || lowerState === 'finished') return 'badge-success'
  if (lowerState === 'failed' || lowerState === 'canceled') return 'badge-danger'
  if (lowerState === 'created' || lowerState === 'scheduled') return 'badge-info'
