...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', '管理員', '6e880b9796d820050647bb0dd15ca857', 'yan', '0', 'long');
...
-- ----------------------------
INSERT INTO `sys_permission` VALUES ('1', '', '使用者管理', '0', '0/', 'admin:view', 'menu', 'admin/list');
INSERT INTO `sys_permission` VALUES ('2', '', '使用者加入', '1', '0/1', 'admin:add', 'button', 'admin/add');
INSERT INTO `sys_permission` VALUES ('3', '', '使用者移除', '1', '0/1', 'admin:del', 'button', 'admin/del');
