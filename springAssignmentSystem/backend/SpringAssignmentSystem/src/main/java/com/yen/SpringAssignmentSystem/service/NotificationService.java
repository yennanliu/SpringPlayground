...
public class NotificationService {
    ...
    String API_URL = "https://api.mailgun.net/v3/coderscampus.com/messages";

    private final Logger log = LoggerFactory.getLogger(NotificationService.class);


    public ResponseEntity<?> sendEmail(String toEmail, String message, String textMessage, String subject) {
        ...
        if (activeProfiles != null && Arrays.stream(activeProfiles).anyMatch(profile -> "local".equalsIgnoreCase(profile))) {
            ...
            // TODO :  check this
            ResponseEntity<String> response = rt.exchange(API_URL, HttpMethod.POST, entity, String.class);
