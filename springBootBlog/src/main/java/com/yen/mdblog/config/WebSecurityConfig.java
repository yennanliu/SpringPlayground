...
//                .passwordEncoder(new BCryptPasswordEncoder()) // password encoding : //
...
//                //.antMatchers("swagger-ui/index.html").permitAll() // allow access swagger UI
// without login
...
//                .and()
//                .formLogin()
//                .defaultSuccessUrl("/posts/all") // default success url :
// https://juejin.cn/post/7032566211414065159
//                .and()
//                .httpBasic();
//    }
//
