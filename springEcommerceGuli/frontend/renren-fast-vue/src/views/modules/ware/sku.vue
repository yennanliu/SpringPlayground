  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item label="Ware">
        <el-select style="width:160px;" v-model="dataForm.wareId" placeholder="Choose ware..." clearable>
    ...
    >
      ...
      <el-table-column prop="stock" header-align="center" align="center" label="Quantity"></el-table-column>
      <el-table-column prop="skuName" header-align="center" align="center" label="SKU Name"></el-table-column>
      <el-table-column prop="stockLocked" header-align="center" align="center" label="Lock Quantity"></el-table-column>
