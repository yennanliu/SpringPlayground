 ...
 * NOTE :
 *
 * use Mockito to mock the DepartmentRepository dependency
 * and JUnit to write the actual tests.
 * The @Mock annotation is used to create a mock of the repository,
 * and @InjectMocks is used to inject the mock into the service being tested.
...
class DepartmentServiceTest {
    ...
    public void testAddDepartment() {
        ...
        /**
         *
         * 1) verify(departmentRepository, times(1)): This part of the code is using Mockito's verify method to verify that a specific interaction with the departmentRepository mock occurred. In this case, it's checking that the save method was called on the departmentRepository.
         *
         ...
         * the verify statement is ensuring that the save method of
         * the departmentRepository was called exactly once with
         * any Department object as an argument.
         * If this verification fails
         * (i.e., if the save method was not called or was called more than once),
         * the test will fail.
         */
