...
public class ProductTypeController {
  ...
  public String createBatch(@RequestParam("file") MultipartFile file, Map<String, Object> map) {
    ...
    try {
      ...
      // System.out.println(">>> res = " + res); // >>> res = ["100001,type-1", "100002,type-2",
      // "100003,type-3"]
  ...
  public String list(
    ...
    IPage<ProductType> iPage =
        productTypeService.page(
            page, new LambdaQueryWrapper<ProductType>().orderByAsc(ProductType::getTypeId));
    log.info(
