...
public class ReactiveStreamsExample2 {
  ...
  public static void main(String[] args) throws InterruptedException {
     ...
     *
     * <p>Flow.Processor<subscribe data type, publish data type>
     */
  ...
  /**
   * define flow intermedia operation (only need to implement subscribe interface, since we extend
   * SubmissionPublisher already
   */
